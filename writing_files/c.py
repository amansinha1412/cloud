...
f.write("\ni=commands.getstatusoutput(\'sudo yum install openssh-server\')")
f.write("\ne=commands.getstatusoutput(\'sudo yum install sshpass\')")
f.write("\nprint e")
...
f.write("\nf=commands.getstatusoutput(\"sudo sshpass -p qwerty ssh -X -l root 192.168.43.68 "+name+"\")")
f.write("\nprint f")
